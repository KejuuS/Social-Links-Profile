  ...
  return (
    <div>
      <div className="container flex items-center justify-center w-full h-screen">
        <div className="bg-darkGrey w-[375px] h-[430px] rounded-lg">
          <div className="flex flex-col items-center justify-start">
            ...
            <div className="my-3 text-center">
              <h1 className="text-xl font-bold text-white">Muhammad Azkal Azkia</h1>
              <p className="mb-4 text-sm font-semibold text-primary">
                Jakarta, Indonesia
              </p>

              <p className="text-sm text-white font-base">
                "A passionate frontend developer from Jakarta"
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center my-3">
              {List.map(({ href, title, img }) => (
                ...
                >
                  ...
                  <li
                    className="group-hover:text-offBlack list-none text-sm font-semibold text-white group-[hover:text-offblack] tracking-normal pr-10"
                    key={href}
                  >
                    {title}
                  </li>
